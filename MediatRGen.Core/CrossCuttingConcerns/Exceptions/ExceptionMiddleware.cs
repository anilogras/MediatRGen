using MediatRGen.Core.CrossCuttingConcerns.Exceptions.Handlers;
using MediatRGen.Core.CrossCuttingConcerns.Logging;
...
namespace MediatRGen.Core.CrossCuttingConcerns.Exceptions;
