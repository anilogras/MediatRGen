using MediatRGen.Core.CrossCuttingConcerns.Serilog;
using MediatRGen.Core.CrossCuttingConcerns.Serilog.ConfigurationModels;
using MediatRGen.Core.CrossCuttingConcerns.Serilog.Messages;
...
namespace MediatRGen.Core.CrossCuttingConcerns.Serilog.Logger;
