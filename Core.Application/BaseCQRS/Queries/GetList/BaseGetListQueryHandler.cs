...
{
    public class BaseGetListQueryHandler<TRequest, TResponse, TEntity> : IRequestHandler<TRequest, TResponse>
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        public BaseGetListQueryHandler(IRepository<TEntity> repository, IMapper mapper)
        {
